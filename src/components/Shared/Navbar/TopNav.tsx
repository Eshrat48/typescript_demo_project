...
export default function TopNav() {
  return (
    <header className="w-full bg-[#F4F6F9] border-b border-gray-200 sticky top-0 z-50">
      ...
      <div className="max-w-full mx-auto px-4 sm:px-6 lg:px-8 h-12 flex items-center justify-between">
        <div className="flex items-center gap-4">
          <a href="#" className="flex items-center gap-3">
            ...
            <div className="flex flex-col leading-tight">
              <span className="text-xs font-semibold text-[#f29100]">SAMS Planner</span>
            </div>
          </a>
        </div>
        ...
        <div className="flex items-center gap-2">
          ...
          <div className="flex items-center gap-3 pl-2 border-l border-gray-100">
            ...
            <button aria-label="Log in" className="ml-2 px-2 py-1 bg-indigo-600 text-white text-sm rounded-md hover:bg-indigo-700">Log in</button>
          </div>
        </div>
      </div>
    </header>
