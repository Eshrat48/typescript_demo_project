          ...
          <div className="flex-1">
            <div className="mb-6">
              <div className="flex items-center gap-2">
                <button
                  onClick={() => navigate(-1)}
                  className="p-2 rounded-md bg-[rgb(70,61,149)] text-white cursor-pointer"
                >
              ...
              <h1 className="text-[28px] font-bold mt-5.5">Welcome to <span className="text-[#334155]">SAMS</span> <span className="text-[#F29100]">Planner</span></h1>
            </div>
            ...
            <div className="mb-6">
              <button disabled={!agreed} onClick={handleContinue} className={`px-4 py-1.5 text-sm rounded-md font-semibold ${agreed ? 'bg-[#F29100] text-white hover:bg-[#F29100]' : 'bg-gray-100 text-gray-400 cursor-not-allowed'}`}>
                Configure the System
              </button>
            </div>
          </div>
          <div className="w-1/2 mt-25 flex items-center justify-center">
